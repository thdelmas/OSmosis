# Download links — SM-T805 / chagalllte (Galaxy Tab S 10.5 LTE)

These are the URLs the wizard assumes for the Galaxy Tab S 10.5 LTE.
...
## MindTheGapps (Android 11, ARM) — for LineageOS only (not /e/OS)
